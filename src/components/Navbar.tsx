    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3 bg-[#4a1521]/65 border border-[#5d1f2e]/40 backdrop-blur-2xl px-5 py-2.5 rounded-full shadow-[0_12px_36px_rgba(74,21,33,0.18)]">
            {navLinks.map((link) => {
